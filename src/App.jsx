...
About Yasmeen:
- Third-year Robotics & AI student at Thapar Institute of Engineering & Technology (TIET), Patiala, India
...
export default function Portfolio() {
  ...
  return (
    <div style={{ background: "#020408", minHeight: "100vh", color: "#e2eaf2", fontFamily: "'Space Grotesk', sans-serif", overflowX: "hidden", opacity: loaded ? 1 : 0, transition: "opacity .4s", cursor: "none" }}>
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Space+Grotesk:wght@400;500;600;700&family=Syne:wght@700;800;900&display=swap');
      ...
      {/* ══ NAV ══ */}
      <nav style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 800, height: 60, background: `rgba(2,4,8,${0.4 + navAlpha * 0.5})`, backdropFilter: `blur(${navAlpha * 16}px)`, borderBottom: `1px solid rgba(255,255,255,${0.02 + navAlpha * 0.04})`, display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 clamp(20px,5vw,80px)" }}>
      ...
      <section id="hero" style={{ minHeight: "100vh", display: "flex", flexDirection: "column", justifyContent: "center", padding: "100px clamp(20px,8vw,120px) 80px", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ position: "relative", zIndex: 2, maxWidth: 1000 }}>
          ...
          <p style={{ fontSize: "clamp(15px,1.6vw,18px)", color: "#4a6a7a", lineHeight: 1.8, maxWidth: 500, marginBottom: 52, fontWeight: 500, animation: "fadeUp .9s ease .55s both" }}>
            Third-year Robotics & AI undergraduate shipping production-grade machine learning systems — from live CV pipelines to deep learning models that actually work in the real world.
          </p>
          ...
          <div>
            <R>
              ...
              <p style={{ fontSize: 15, color: "#4a6a7a", lineHeight: 1.9, marginBottom: 18, fontWeight: 500 }}>
                I'm Yasmeen — a third-year Robotics & AI student obsessed with the intersection of perception and intelligence. From real-time video analysis to predictive models deployed in the wild, I build systems that actually ship.
              </p>
